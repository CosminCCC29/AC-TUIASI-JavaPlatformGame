...
/*! \class CrazyWizard extends Characters
    \brief Implementeaza un personaj al jocului de tip CrazyWizard.
 */
public final class CrazyWizard extends Characters {

    /*! \fn public CrazyWizard(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei CrazyWizard.
     ...
     */
    public CrazyWizard(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.CrazyWizard,refLinks, x, y, ObjectId.CrazyWizard, new Clip[][]{AudioAssets.Zaps, AudioAssets.Zaps}, AudioAssets.MagicDeath, handler);
