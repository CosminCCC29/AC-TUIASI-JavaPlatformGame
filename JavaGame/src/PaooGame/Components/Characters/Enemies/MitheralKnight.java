...
/*! \class MitheralKnight extends Characters
    \brief Implementeaza un personaj al jocului de tip MitheralKnight.
 */
public final class MitheralKnight extends Characters {

    /*! \fn public MitheralKnight(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei MitheralKnight.
     ...
     */
    public MitheralKnight(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.MitheralKnight,refLinks, x, y, ObjectId.MitheralKnight, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
