...
/*! \class Ghost extends Characters
    \brief Implementeaza un personaj al jocului de tip Ghost.
 */
public final class Ghost extends Characters {

    /*! \fn public Ghost(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei Ghost.
     ...
     */
    public Ghost(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.Ghost,refLinks, x, y, ObjectId.Ghost, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
