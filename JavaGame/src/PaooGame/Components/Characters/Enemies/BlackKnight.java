...
/*! \class BlackKnight extends Characters
    \brief Implementeaza un personaj al jocului de tip BlackKnight.
 */
public final class BlackKnight extends Characters {

    /*! \fn public BlackKnight(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei BlackKnight.
     ...
     */
    public BlackKnight(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.BlackKnight,refLinks, x, y, ObjectId.BlackKnight, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
