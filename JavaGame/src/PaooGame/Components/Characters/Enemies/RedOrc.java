...
/*! \class RedOrc extends Characters
    \brief Implementeaza un personaj al jocului de tip RedOrc.
 */
public final class RedOrc extends Characters {

    /*! \fn public RedOrc(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei RedOrc.
     ...
     */
    public RedOrc(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.RedOrc,refLinks, x, y, ObjectId.RedOrc, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.OrcDeath, handler);
