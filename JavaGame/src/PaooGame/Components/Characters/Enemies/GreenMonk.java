...
/*! \class GreenMonk extends Characters
    \brief Implementeaza un personaj al jocului de tip GreenMonk.
 */
public final class GreenMonk extends Characters {

    /*! \fn public GreenMonk(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei GreenMonk.
     ...
     */
    public GreenMonk(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.GreenMonk,refLinks, x, y, ObjectId.GreenMonk, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
