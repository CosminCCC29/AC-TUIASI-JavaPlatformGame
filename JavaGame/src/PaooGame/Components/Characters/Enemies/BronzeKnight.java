...
/*! \class BronzeKnight extends Characters
    \brief Implementeaza un personaj al jocului de tip BronzeKnight.
 */
public final class BronzeKnight extends Characters {

    /*! \fn public BronzeKnight(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei BronzeKnight.
     ...
     */
    public BronzeKnight(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.BronzeKnight,refLinks, x, y, ObjectId.BronzeKnight, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
