...
/*! \class Priest extends Characters
    \brief Implementeaza un personaj al jocului de tip Priest.
 */
public final class Priest extends Characters {

    /*! \fn public Priest(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei Priest.
     ...
     */
    public Priest(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.Priest,refLinks, x, y, ObjectId.Priest, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
