...
/*! \class YoungThief extends Characters
    \brief Implementeaza un personaj al jocului de tip YoungThief.
 */
public final class YoungThief extends Characters {

    /*! \fn public YoungThief(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei YoungThief.
     ...
     */
    public YoungThief(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.YoungThief,refLinks, x, y, ObjectId.YoungThief, new Clip[][]{AudioAssets.SwordHitAttacks, AudioAssets.SwordMissAttacks}, AudioAssets.ManDeath, handler);
