...
/*! \class PrinceRanger extends Characters
    \brief Implementeaza un personaj al jocului de tip PrinceRanger.
 */
public final class PrinceRanger extends Characters {

    /*! \fn public PrinceRanger(RefLinks refLinks, float x, float y, ObjectsHandler handler)
        \brief Constructor de initializare al clasei PrinceRanger.
     ...
     */
    public PrinceRanger(RefLinks refLinks, float x, float y, ObjectsHandler handler) {
        super(Assets.PrinceRanger,refLinks, x, y, ObjectId.PrinceRanger, new Clip[][]{AudioAssets.BowHitAttacks, AudioAssets.BowMissAttacks}, AudioAssets.ManDeath, handler);
